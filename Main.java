...
public static void exitSystem() {
 ...
 public static String[][] supplierManage(String[][] supplier , String [] category , String [][]item) {
...
public static void viewSupplier(String[][] supplier , String [] category , String [][] item) {
    ...
    for (int i = 0; i < supplier.length; i++) {
        if (supplier[i][0] != null & supplier[i][1] != null ){
            System.out.printf("|%-10s | %-10s |%n", supplier[i][0],supplier[i][1]);
        }
    }
...
public static String[] manageItemCategories(String[][] supplier, String[] category , String [][] item) {
 
    Scanner scanner = new Scanner(System.in);
 
    System.out.println("+-----------------------------------------------------------------------------+");
    System.out.println("|                               MANAGEITEMCATEGORY                            |");
    System.out.println("+-----------------------------------------------------------------------------+\n");
...
public static String[] addNewItemCategory(String[][] supplier, String[] category , String [][] item) {
    ...
    while (addNewCategory = true) {
        ...
        System.out.println("+-----------------------------------------------------------------------------+");
        System.out.println("|                                 ADDITEM CATEGORY                            |");
        System.out.println("+-----------------------------------------------------------------------------+\n");
...
public static String[][] addItem(String[][] supplier, String[] category, String[][] item) {
    ...
    while (add == true) {
        ...
        if (!checkId) {
            System.out.println("\n\nSuppliers list:");
            System.out.printf("+----------------+----------------------+-----------------------+%n");
            System.out.printf("|  %-8s | %-10s | %-10s |%n", "#","SUPPLIER ID", "SUPPLIER NAME");
            System.out.printf("+----------------+----------------------+-----------------------+%n");
            ...
            System.out.printf("+----------------+-----------------------+%n");
            System.out.printf("| %-8s | %-15s |%n" , "#" , "CATEGORY", "NAME");
            System.out.printf("+----------------+-----------------------+%n");

            for (int i = 0; i < category.length; i++) {
                if (category[i] != null){
                    System.out.printf("|%-8s | %-15s |%n" ,(i+1) , category[i]);
                }
            }
    ...
    while (searchsup = true ) {
        ...
        for (int i = 0; i < supplier.length; i++) {
            if (supplier[i][0] != null && supplier[i][0].equals(supplierId)) {
                ...
                System.out.printf("+------------+-----------------+------------+-------------+------------+%n");
                System.out.printf("| %-10s | %-15s | %-10s | %-10s | %-10s |%n", "Item Code","Description", "Unit Price", "Qty On Hand", "Category");
                System.out.printf("+------------+-----------------+------------+-------------+------------+%n");

                        for (int j = 0; j < item.length; j++) {
                            if (item[j][1] != null && item[j][1].equals(supplierId)) {
                                System.out.printf("| %-10s | %-15s | %-10s | %-10s | %-10s |%n",item[j][0], item[j][3], item[j][4], item[j][5], item[j][2]);
                            }
                        }
                        System.out.printf("+------------+-----------------+------------+-------------+------------+%n");
                    }
...
public static void viewItem (String [][] supplier , String [] category , String [][] item){
    ...
    for (int i = 0; i < category.length; i++){
        ...
        System.out.printf("+-------------+------------+-------------+------------+-------------+%n");
        System.out.printf("| %-10s | %-10s | %-10s | %-10s | %-10s |%n", "Supplier ID", "Item Code", "Description", "Unit Price", "qty On Hand");
        System.out.printf("+-------------+------------+-------------+------------+-------------+%n");
...
public static void rankItemsPerUnitPrice(String[][] supplier, String[] category, String[][] item){
    ...
    System.out.printf("+--------------+------------+--------------+------------+--------------+------------+%n");
    System.out.printf("| %-12s | %-10s | %-12s | %-10s | %-12s | %-10s |%n", "Supplier ID","Item Code", "Description", "Unit Price", "Qty On Hand", "Category");
    System.out.printf("+--------------+------------+--------------+------------+--------------+------------+%n");
    ...
    for (double unitPrice : sortedUnitPrices) {
        for (String[] currentItem : item) {
            if (Double.parseDouble(currentItem[4]) == unitPrice) { // Convert String to double
                System.out.printf("| %-12s | %-10s | %-12s | %-10s | %-12s | %-10s |%n",currentItem[1], currentItem[0], currentItem[3], currentItem[4], currentItem[5], currentItem[2]);
            }
        }
    }
